...
;M301 H1 P12 I0.4 D80 W180 B300         ; Set heater PID parameters - old style
M307 H1 A201.5 C49.1 D2.2 B0 S1.0 V19  ; Set heater PID parameters - new style
...
;Bed probe and compensation definition
M558 P4 X0 Y0 Z0 H4 ; Z probe is a switch and is not used for homing any axes
G31 X0 Y0 Z0.0 P200 ; Set the zprobe height and threshold (put your own values here during calibration)
